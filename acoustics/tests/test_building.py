...
from ..building import rw_curve, rw, rw_c, rw_ctr, stc, stc_curve, mass_law


def setup_module(building):
    building.tl = np.array([10, 11, 12, 13, 15, 18, 20, 20, 25, 22, 18, 15,
                            20, 25, 28, 30])
