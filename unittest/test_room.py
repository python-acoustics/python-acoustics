...
@pytest.mark.parametrize("file_name, bands, rt, expected", [
    ...
    ('living_room_1.wav', third(100, 5000), 't20',
    ...
    ('living_room_1.wav', third(100, 5000), 't10',
    ...
    ('living_room_1.wav', third(100, 5000), 'edt',
