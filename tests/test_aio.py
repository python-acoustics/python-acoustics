...
cirrus_files = list(itertools.product(details_type, int_time, delimiter,
                                      decimals))
cirrus_files.extend(list(itertools.product(["det_global_general"],
                                           delimiter, decimals)))
cirrus_files.extend(list(itertools.product(time_history, ["oct"], weighting,
                                           delimiter, decimals)))
cirrus_files.extend(list(itertools.product(["overall_third"], weighting,
                                           delimiter, decimals)))
